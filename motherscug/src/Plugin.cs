...
{
    [BepInPlugin(MOD_ID, "The Mother", "0.1.0")]
    [BepInDependency("slime-cubed.slugbase")]
    class Plugin : BaseUnityPlugin
    {
        private const string MOD_ID = "styxnstonez.motherscug";

        public static readonly PlayerFeature<float> SuperJump = PlayerFloat("motherscug/super_jump");
        public static readonly PlayerFeature<bool> ExplodeOnDeath = PlayerBool("motherscug/explode_on_death");
